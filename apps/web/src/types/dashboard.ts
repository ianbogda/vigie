...
export type PcifContext = { mastery_level?: number; major_risks?: number; open_actions?: number; overdue_actions?: number; campaign_label?: string; trend?: string; source_url?: string; updated_at?: string };
export type Eple = {
