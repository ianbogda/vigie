...
export const VIEW_HELP: Record<string, ViewHelpSpec> = {
  'Analyse financière': { purpose:"Comprendre la situation financière de l’établissement à partir des données consolidées dans Vigie.", sources:[{name:'YFDR',format:'CSV'},{name:'EBLC',format:'XLSX'},{name:'YCONSDEP / YCONSREC',format:'XLSX'},'YBALAC','YBALAF',{name:'Compte 5151',format:'CSV'}], notes:["Les pas-à-pas OP@LE seront ajoutés à mesure de leur validation terrain."] },
  'Budget': { purpose:"Suivre la construction et l’exécution budgétaires de l’établissement.", sources:[{name:'Budget OP@LE',format:'.lis ou .xlsx'},{name:'EBLC',format:'XLSX'}], notes:["Le gabarit d’aide est prêt ; le parcours OP@LE reste à documenter."] },
  ...
  'Comptabilité générale': { purpose:"Examiner les comptes des classes 1 à 8 et les anomalies comptables détectées par Vigie.", sources:[{name:'Données comptables OP@LE — classes 1 à 8',format:'CSV'},'YGPIE1'], notes:["YGPIE1 alimente les pièces non soldées et les rapprochements."] },
