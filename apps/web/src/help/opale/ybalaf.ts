  ...
  steps: [
    {
      n: '1',
      title: 'Ouvrir YBALAF',
      description: 'Saisir le mnémonique YBALAF, puis cliquer sur OK.',
      image: ybalaf01
    },
    {
      n: '2',
      ...
      description:
        'Dans « Balance âgée fournisseurs », renseigner la période à analyser, puis cliquer sur la double flèche en haut de la fenêtre.',
      image: ybalaf02
    },
    {
      n: '3',
    ...
    },
    {
      ...
      description:
        'Dans Fournisseurs, cliquer sur « Importer », choisir l’établissement concerné, sélectionner le fichier XLSX créé puis cliquer sur « Importer ».'
    }
  ]
};
