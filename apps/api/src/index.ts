...
app.get('/health',()=>({ok:true,version:'0.0.1'})); app.get('/api/dashboard',()=>({updatedAt:new Date().toISOString(),kpis:{eple:8,alerts:3,treasury:2800000,execution:0.96},establishments,alerts}));
